...
public class Parser {
    ...
    public void saveJSON(String json) {
        try(FileWriter writer = new FileWriter("src/ru/practice_25_to_26/metro.json", false)) {
            writer.write(json);
            writer.flush();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void openJSON() {
        String json = "";
        try(FileReader reader = new FileReader("src/ru/practice_25_to_26/metro.json")) {
            // читаем посимвольно
            int c;
